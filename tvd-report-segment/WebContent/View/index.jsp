...
<table>
	<tr>
		<td>
		<input type="radio" name="segment_type" id="sms" class="segment" value="sms"> SMS	
		<input type="radio" name="segment_type" id="mail" class="segment" value="mail"> Mail	
		<input type="radio" name="segment_type" id="insurance" class="segment" value="insurance"> Insurance	
		</td>
	</tr>
</table>		
<div id="mainBody">
